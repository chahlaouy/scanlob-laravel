        ...
        <div class="bg-white rounded-2xl shadow-2xl p-6 text-center text-gray-700 mt-8">
            ...
            @csrf
                ...
                <label class="block mt-4">
                    ...
                    <input type="text" class="form-input mt-1 block w-full py-2 border-2 border-gray-300 rounded focus:outline-indigo-600" placeholder="60$" name="price">
                </label>
                <label class="block mt-4">
                    <div class="text-gray-700 text-left">Description</div>
                    <textarea type="text" class="form-input mt-1 block w-full p-2 border-2 border-gray-300 rounded focus:outline-indigo-600" placeholder="description ici" rows="5"></textarea>
                </label>
                <label class="block mt-4">
